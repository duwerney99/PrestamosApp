  ...
  return (
    <div>
      <div className="min-h-screen bg-blue-400 flex justify-center items-center">
        ...
        <div className="absolute w-48 h-48 rounded-xl bg-blue-300 bottom-20 -right-10 right-10 transform rotate-12 hidden md:block">
        </div>
        <div className="py-12 px-12 bg-white rounded-2xl shadow-xl z-20">
          <div>
            <h1 className="text-3xl font-bold text-center mb-4 cursor-pointer">Vuce</h1>
